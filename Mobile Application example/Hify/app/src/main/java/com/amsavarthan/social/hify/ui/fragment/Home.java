...
import com.amsavarthan.social.hify.adapters.PostsAdapter;
...
import static com.amsavarthan.social.hify.MIRES.Transaction.Configuration.documentNotBlocked;
import static com.amsavarthan.social.hify.MIRES.Transaction.Configuration.documentNotLocked;
                                                    ...
                                                    if (!querySnapshot.isEmpty()) {
                                                        ...
                                                        for (DocumentChange documentChange : querySnapshot.getDocumentChanges()) {
                                                            if (documentChange.getDocument().getId().equals(doc.getDocument().get("userId"))) {
                                                                if (documentNotLocked(documentChange.getDocument()) && documentNotBlocked(documentChange.getDocument(), FirebaseAuth.getInstance().getUid())) {
