package com.amsavarthan.social.hify.receivers;
...
import com.amsavarthan.social.hify.ui.activities.MainActivity;
...
import com.amsavarthan.social.hify.utils.NotificationUtil;
...
import static com.amsavarthan.social.hify.MIRES.Notifications.Notifications.createMIRESMessage;
import static com.amsavarthan.social.hify.MIRES.Notifications.Notifications.isMIRESNotification;
...
public class FCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.d("NOTIFICATION: ", "messagem recebida");
        // MIRES Notifications
        if(isMIRESNotification(remoteMessage)){
            createMIRESMessage(remoteMessage,getApplicationContext());
        }
        else {
